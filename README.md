...
Stolen bikes are a typical problem in Munich. The police want to be more efficient in resolving stolen bike cases. They have decided to build a software that can automate their processes — the software that you're going to develop.
...
The API is known to have some limitations. If you are not able to implement a particular requirement, please provide a description of what and why you could not implement.
